...
REM
REM Generated by Vivado on Tue Oct 28 23:51:25 -0700 2025
...
echo "xvlog --incr --relax -prj tb_TwoBitRCA_vlog.prj"
call xvlog  --incr --relax -prj tb_TwoBitRCA_vlog.prj -log xvlog.log
