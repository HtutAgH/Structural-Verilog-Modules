...
REM
REM Generated by Vivado on Fri Oct 17 18:51:36 -0700 2025
...
echo "xvlog --incr --relax -prj tb_RCA_vlog.prj"
call xvlog  --incr --relax -prj tb_RCA_vlog.prj -log xvlog.log
