...
REM
REM Generated by Vivado on Wed Nov 26 00:22:06 -0800 2025
...
echo "xvlog --incr --relax -prj Counter4bit_tb_vlog.prj"
call xvlog  --incr --relax -prj Counter4bit_tb_vlog.prj -log xvlog.log
