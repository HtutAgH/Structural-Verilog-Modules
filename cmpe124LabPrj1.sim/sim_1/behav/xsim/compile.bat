...
REM
REM Generated by Vivado on Fri Oct 17 19:19:26 -0700 2025
...
echo "xvlog --incr --relax -prj tb_FourBitsSubtractor_vlog.prj"
call xvlog  --incr --relax -prj tb_FourBitsSubtractor_vlog.prj -log xvlog.log
